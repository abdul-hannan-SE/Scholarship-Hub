...
const Option2Form = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    monthlyIncome: 0,
    cgpa: 3.0,
    hasFirstDivisionThroughtAcademicia: false,
    hasCompletedMS: false,
    isEmployeeOfPublicSector: false,
  });
    ...
    >
      ...
      <label className="admin-form-label">
        ...
        <input
          ...
          checked={formData.hasOtherScholarship}
          onChange={handleChange}
        />
      </label>
      <br />
      ...
      <br />
      <label className="admin-form-label">
        Has First Division Throughout Academics:
        <input
          className="admin-form-checkbox"
          type="checkbox"
          name="hasFirstDivisionThroughtAcademicia"
          checked={formData.hasFirstDivisionThroughtAcademicia}
          onChange={handleChange}
        />
      </label>
      <br />
      <label className="admin-form-label">
        ...
        <input
          ...
          type="checkbox"
          name="hasCompletedMS"
          checked={formData.hasCompletedMS}
          onChange={handleChange}
        />
      </label>
      <br />
      <label className="admin-form-label">
        Is Employee Of Public Sector:
        <input
          className="admin-form-checkbox"
          type="checkbox"
          name="isEmployeeOfPublicSector"
          checked={formData.isEmployeeOfPublicSector}
          onChange={handleChange}
        />
      </label>
      <br />
