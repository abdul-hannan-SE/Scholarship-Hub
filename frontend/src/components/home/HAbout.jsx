...
import { blog, coursesCard } from "../../dummydata";
...
const HAbout = () => {
  ...
  useEffect(() => {
    const getPopularAdminPosts = async () => {
      try {
        const response = await fetch(
          "http://localhost:8080/user/popular-programs",
          {
            headers: {
    ...
    <>
      <section className="blog">
        <div className="container">
          <Heading
            subtitle="Popular Programs"
            title="Most Popular Programs Posted By Admin"
          />
